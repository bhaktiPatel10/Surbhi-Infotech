...
const AppDevelopmentPopup = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (validate) {
            ...
            const scriptURL = 'https://script.google.com/macros/s/AKfycbzdOJS4sQju4L-VBYNOwUDTVhlPQ3Xsa2dyMerQpIMBETQWUr_EFNnnRT8eQYFj48JOWQ/exec'
            ...
            <section className="modal-shopify-popoup">
                ...
                <div id="shopifyPopup" className="modal-container-shopify">
                    ...
                    <div id="modal-root" className="modal-content-shopify new-width">
                        <div>
                            <img className="side-img" src="/images/app-dev-popup-bg.png" />
                        </div>
...
export default AppDevelopmentPopup;