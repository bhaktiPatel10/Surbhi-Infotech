                ...
                <div className="">
                        ...
                        <div className="container-new">
                            <div className="about-client-section row">
                                ...
                                <div className="about-client-right w-50">
                                    <img src="images/case-study/nestspaceweb1.png" className="about-client-right-img" />
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="container-new">
                            <div className="our-role-section row">
                                <div className="role-left-section w-50">
                                    <img className="laptop-img" src="images/case-study/nestspaceweb2.png" alt="" />
                        ...
                        <div className="container-new">
                            <div className="project-specification-section row">
                                ...
                                <div className="w-50 pro-specification">
                                    <img className="laptop-img" src="images/case-study/nestspaceweb3.png" alt="" />
                    ...
                    <section className="bg-laptop-inner mt-10">
                        <div className="container-new">
                            <div className="our-role-section row">
                                <div className="role-left-section w-50">
                                    <img className="laptop-img" src="images/case-study/nestspaceweb4.png" alt="" />
                                    {/* <img className="back-round-img" src="images/case-study/round-180.png" alt="" /> */}
                                </div>
                                <div className="role-right-section w-50">
                                    <div className="client-name">
                                ...
                                Project Description
                                    ...
                                    <div className="role-desc">
                                        <div className="">
                                            Netspace is the finest platform for buying and selling real estate. We may add several properties for buy and sale in this platform, similar to housing.com. Netspace is a housing.com competitor website.
                                        </div>
                                    </div>
                                </div>
                            </div>
